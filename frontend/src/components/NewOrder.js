...
const NewOrder = () => {
  ...
  const handleSupplierChange = (value) => {
    ...
    if (value === 'Bell Plaster'){
      ...
      setInstallationCategory(['Plasterboard','Framing Wall', 'Framing Ceiling', 'Insulation', 'Others'])
    }
    else if (value === 'Intex'){
      document.getElementById('fieldset-filter').style.display = "block"
      document.getElementById('chk-plasterboard').checked = true;
      document.getElementById('chk-framing_wall').checked = true;
      document.getElementById('chk-framing_ceiling').checked = true;
      document.getElementById('chk-insulation').checked = false;
      ...
      document.getElementById('fieldset-filter').style.display = "block"
      document.getElementById('chk-plasterboard').checked = true;
      document.getElementById('chk-framing_wall').checked = false;
      document.getElementById('chk-framing_ceiling').checked = false;
      document.getElementById('chk-insulation').checked = true;
      setInstallationCategory(['Plasterboard', 'Insulation', 'Others'])

    }
    else if (value === 'K8'){
      document.getElementById('fieldset-filter').style.display = "block"
      document.getElementById('chk-plasterboard').checked = false;
      document.getElementById('chk-framing_wall').checked = false;
      document.getElementById('chk-framing_ceiling').checked = false;
      document.getElementById('chk-insulation').checked = true;
      setInstallationCategory(['Insulation', 'Others'])
    }
      ...
      document.getElementById('chk-framing_ceiling').checked = true;
      document.getElementById('chk-insulation').checked = false;
      setInstallationCategory(['Framing Wall', 'Framing Ceiling', 'Others'])
    }
    else {
